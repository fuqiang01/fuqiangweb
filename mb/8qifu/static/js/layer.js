...
;!function (a, b) {
    ...
    var c, d, e = {
        ...
        v: "2.1", ie6: !!a.ActiveXObject && !a.XMLHttpRequest, index: 0, path: e.getPath, config: function (a, b) {
            var d = 0;
            return a = a || {}, f.cache = e.config = c.extend(e.config, a), f.path = e.config.path || f.path, "string" == typeof a.extend && (a.extend = [a.extend]), f.use("Images/layer.css", a.extend && a.extend.length > 0 ? function g() {
                var c = a.extend;
